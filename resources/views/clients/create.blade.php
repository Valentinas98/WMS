...
<x-app-layout>
    ...
    <div class="container">
        ...
        <form action="/clients" method="post" class="center_form">


            <div class="form-group">
                <label for="client_name">Kliento vardas</label>
                <input class="text" type="text" name="client_name" autocomplete="off" value="{{ old('client_name') }}">
            ...
            <div class="form-group">
                ...
                <input class="text" type="text" name="client_phone_number" autocomplete="off" value="{{ old('client_phone_number') }}">
            ...
            <div class="form-group">
                ...
                <input class="text" type="text" name="client_email" autocomplete="off" value="{{ old('client_email') }}">
            ...
            <div class="form-group">
                ...
                <input class="text" type="text" name="client_code" autocomplete="off" value="{{ old('client_code') }}">
            ...
            <div class="form-group">
                ...
                <input class="text" type="text" name="client_VAT_code" autocomplete="off" value="{{ old('client_VAT_code') }}">
                @error('client_VAT_code') <p style="color: red;">{{'Neįvestas PVM mokėtojo kodas.'}}</p> @enderror
            </div>

            <div class="form-group">
                <label for="client_address">Adresas</label>
                <input class="text" type="text" name="client_address" autocomplete="off" value="{{ old('client_address') }}">
            ...
            <div class="tarpas">
                <button class="btn btn-outline-success">Pridėti naują klientą</button>
            </div>
