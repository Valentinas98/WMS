...
<x-app-layout>
    ...
    <div class="container">
        ...
        <form action="/inbounds" method="post" class="center_form">

            <div class="form-group">
                <label for="inbound_date">Priėmimo Data</label>
                <input class="text" type="date" name="inbound_date" autocomplete="off"
                       value="{{ old('inbound_date') }}">
                @error('inbound_date') <p style="color: red;">{{'Data nepasirinkta.'}}</p> @enderror
            </div>

            <div class="form-group">
                <label for="inbound_number">Priėmimo numeris</label>
                <input class="text" type="text" name="inbound_number" autocomplete="off"
                       value="{{ old('inbound_number') }}">
            ...
            <div class="form-group">
                ...
                <input class="text" type="text" name="cargo_manifest_number" autocomplete="off" style="text-transform:uppercase"
            ...
            <div class="form-group">
                ...
                <input class="text" type="text" name="product_number" autocomplete="off" style="text-transform:uppercase"
            ...
            <div class="form-group">
                ...
                <input class="text" type="text" name="product_name" autocomplete="off"
            ...
            <div class="form-group">
                ...
                <input class="text" type="text" name="product_quantity" autocomplete="off"
            ...
            <div class="form-group">
                ...
                <input class="text" type="text" name="product_sn" autocomplete="off" style="text-transform:uppercase" value="{{ old('product_sn') }}">
            ...
            <div class="form-group">
                ...
                <input class="text" type="text" name="carrier_license_plate" autocomplete="off" style="text-transform:uppercase"
            ...
            <div class="form-group">
                ...
                <input class="text" type="text" name="carrier_person" autocomplete="off"
                       value="{{ old('carrier_person') }}">
            ...
            <div class="form-group">
                ...
                <input class="text" type="text" name="warehouse_id" autocomplete="off"
            ...
            <div class="tarpas">
                <button name="antrastestas" value="testas" class="btn btn-outline-success" >Sukurti naują įvežimą</button>
            </div>
